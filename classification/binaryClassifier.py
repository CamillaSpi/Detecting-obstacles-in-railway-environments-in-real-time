...
PARAMETERS_AND_NAME_MODEL = 'Training_19_09_Resize_DatasetV2BigBlackPatchesSiCorrected_BatchSize64_SGD_seed18'
...
csv_train_path = '/user/cspingola/TESI/Tesi/Datasets/DatasetV2/train_black_patches_corrected_seed18.csv'
csv_val_path = '/user/cspingola/TESI/Tesi/Datasets/DatasetV2/valid_black_patches_corrected_seed18.csv'
