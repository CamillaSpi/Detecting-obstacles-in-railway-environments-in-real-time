...
PARAMETERS_AND_NAME_MODEL = 'Training_12_10_Resize_DatasetV2BigBlackPatchesSiCorrected_BatchSize64_SGD_reallyBinary_AllSblocked_AugmentationTraining_ResNet101_updated'
...
# models.resnet50
backbone = models.resnet101(pretrained = True) #pretrained on ImageNet
