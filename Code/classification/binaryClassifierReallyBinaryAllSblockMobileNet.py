...
PARAMETERS_AND_NAME_MODEL = 'Training_12_10_Resize_DatasetV2BigBlackPatchesSiCorrected_BatchSize64_SGD_reallyBinary_AllSblocked_AugmentationTraining_MobileNet_updated'
...
csv_train_path = '/user/cspingola/TESI/Tesi/Datasets/DatasetV2/train_black_patches_corrected.csv'
...
#models.resnet50
backbone = models.mobilenet_v2(pretrained = True) #pretrained on ImageNet
...
num_ftrs = backbone.classifier[1].out_features
