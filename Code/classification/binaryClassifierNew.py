...
parser.add_argument("-config_trainable_parameters", type=str, required=True)
...
#PARAMETERS_AND_NAME_MODEL = 'Training_22_08_Resize_BatchSize32_SGD_TrainableOnlyAddedByMeReduced'
PARAMETERS_AND_NAME_MODEL = args.model_name
...
csv_train_path = '/user/cspingola/TESI/Tesi/Datasets/DatasetV2/train.csv'
csv_val_path = '/user/cspingola/TESI/Tesi/Datasets/DatasetV2/valid.csv'
...
config = args.config_trainable_parameters
if config=='3':
    count = 0
...
def train_model(model, base_criterion, optimizer, scheduler, early_stopper,num_epochs=25,best_loss=0.0, numTrain=1, acc_best_loss=0.0):
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            for sample_batched in tqdm(dataloaders[phase]):
                ...
                labels = sample_batched['obstacle'].to(device)
            ...
            path_to_save = '/user/cspingola/TESI/Tesi/TrainingsResults/ClassifierWeights/'
    ...
    path_to_graphs = '/user/cspingola/TESI/Tesi/TrainingsResults/EvaluationCurves/'
